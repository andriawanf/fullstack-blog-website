...
function Navbar() {
    ...
    return (
        // <Disclosure as="nav" className="sticky top-0 z-50 bg-white-500/5 rounded-xl backdrop-blur-xl">
        //     {({ open }) => (
        //         <>
        ...
        <nav
            className="sticky top-0 flex items-center justify-between px-6 py-4 bg-white-500/5 rounded-xl backdrop-blur-xl"
        >
            {/* Left Navbar */}
            <Link to="/" className="flex flex-row items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-blueLight-500"></div>
                <p className="hidden text-lg font-semibold leading-relaxed sm:block font-dm text-white-500">OutoftheBoys</p>
            </Link>
            {/* Menu Navbar */}
